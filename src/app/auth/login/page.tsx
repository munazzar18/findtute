  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Login to access online teaching resources, connect with online tutors, and manage your online classes."
        />
        <meta
          name="keywords"
          content="online teacher, online tutor, online teaching, online classes"
        />
        ...
        <meta
          ...
          content="Login to access online teaching resources, connect with online tutors, and manage your online classes."
        />
        <meta property="og:image" content="/assets/images/shapes/shap.png" />
        <meta property="og:url" content="https://www.findtute.com/auth/login" />
        <meta name="robots" content="noindex, nofollow" />{' '}
        {/* Optional: Prevent indexing if this is a login page */}
      </Head>
      <section className="bg-warm relative min-h-screen w-full">
        ...
        <div className="container relative">
          <div className="flex flex-col items-center text-center relative z-10 ">
            <h1 className="font-normal xl:text-[60px] lg:text-6xl md:text-5xl text-4xl xl:leading-[128%] lg:leading-[125%] md:leading-[120%] max-w-[776px]">
