      ...
      <section className="pt-15">
        <div className=" container">
          <div className=" grid xl:grid-cols-[850px_auto] lg:grid-cols-[670px_auto] grid-cols-1 gap-7.5">
            <div>
                ...
                <div className="pt-7.5">
                  <ul className="flex gap-7.5 pb-5 flex-wrap">
                    ...
                    <li>
                      ...
                      <span className="text-[#686868] ml-2.5">By admin</span>{' '}
                    </li>
                    <li>
                      {' '}
                  ...
                  <p>
                    IT Technology is a rapidly evolving field that encompasses a
                    wide range of computer-rela Technology is a rapidly ya
                    evolving field that encompasses a wide range of
                    computer-related technologies and the services. From
                    software thr development to network
              ...
              <blockquote className="shadow-3xl xl:px-15 px-8 xl:py-[38px] py-5 my-10 rounded-[10px]">
                ...
                <p className="mt-5">
                  ...
                  a galley of type and scrambled loren ipsum
                </p>
                <h4 className="text-xl font-bold leading-[130%] mt-[28px]">
                  Fahad Hossain<span className="text-green-foreground">_</span>{' '}
                </h4>
              </blockquote>
              <div>
                ...
                <div className="mt-7.5">
                  <p>
                    ...
                    ullamcorper posuere viverra .Aliquam erosjust posuer
                    lobortis viverra laoreet augue mattis fermentum
                    ullamcAliquam eros justo, posuere loborti viverra laoreet
                    matti ullamcorper posuere viverra .Aliquam erosjust posuer
                    lobortis viverra laoreet augue mattis fermentum ullamcorper
                    viverra laoreetAliquam eros justo, posuere loborti viverra
                    laoreet matti ullamcorper posuere viverra .Aliquam erosjust
                    posuer lobortis viverra laoreet augue mattis fermentum
                    ullamcorper viverra laoreetorper viverra laoreet
                  </p>
                  <ul className="mt-5 grid sm:grid-cols-2 grid-cols-1 gap-5">
                    <li className="flex items-center gap-4 text-[#686868]">
                      {' '}
                      <span className="w-4 h-4 rounded-full flex items-center justify-center bg-destructive text-cream-foreground">
              ...
              <div className="mt-12">
                <div>
                  <h3 className="text-2xl font-semibold leading-[140%]">
                    Tags:
                  </h3>
                ...
                <div className="mt-10">
                  ...
                  <div className="flex sm:flex-row flex-col gap-5 justify-between items-center pt-6 pb-7">
                    <a
                      href="#"
                      className="text-xl font-bold leading-[130%] flex gap-2.5 items-center font-jost group"
                    >
                      {' '}
                      <span className="group-hover:text-destructive-foreground transition-all duration-500">
                    ...
                    <ul className="flex items-center gap-2.5">
                      <li>
                        <a
                          href="#"
                          className="rounded-full w-10 h-10 flex items-center justify-center border border-destructive hover:text-cream-foreground hover:bg-destructive transition-all duration-500"
                        >
                  ...
                  <form action="#" className="mt-7">
                    <div className="grid sm:grid-cols-2 grid-cols-1 gap-7.5">
                      <div className="relative">
                        ...
                        <label
                          htmlFor="name"
                          className="absolute right-5 top-1/2 -translate-y-1/2 text-primary-foreground"
                        >
                    ...
                    <button className="lg:max-w-[186px] max-w-[140px] w-full lg:mt-10 mt-5 btn-rounded-full">
                      Send Now
                    </button>
                  </form>
                </div>
            ...
            <div>
              <div
                className="bg-background shadow-3xl xl:p-10 p-5 rounded-md wow fadeInUp"
                data-wow-delay=".4s"
              >
              ...
              <div
                className="bg-background shadow-3xl xl:p-10 p-5 rounded-md mt-10 wow fadeInUp"
                data-wow-delay=".5s"
              >
