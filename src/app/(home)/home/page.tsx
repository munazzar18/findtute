            ...
            <div className="">
              <div>
                ...
                <p className="text-justify text-lg sm:text-lg md:text-xl lg:text-2xl">
                  ...
                  <strong> Findtute streamlines the process</strong> with a{' '}
            ...
            <div className="">
              <div>
                ...
                <p className="text-justify text-lg sm:text-lg md:text-xl lg:text-2xl">
                  ...
                  . This helps Findtute connect you with the{' '}
      ...
      <div className="flex flex-col sm:flex-col md:flex-col lg:flex-row px-4 sm:px-4 md:px-16 lg:px-48 items-center justify-between mt-4 sm:mt-4 md:mt-8 lg:mt-16 mb-8 sm:mb-8 md:mb-16 lg:mb-24">
        <div>
          ...
          <p className="font-bold text-lg sm:text-lg md:text-xl lg:text-3xl mb-2 sm:mb-2 md:mb-4 lg:mb-6">
            Unleash Your Teaching Power: 7 Easy Steps to Join Findtute's
            Thriving Tutor Community!
          </p>
          <p className="font-semibold text-md sm:text-md md:text-xl lg:text-2xl mb-2 sm:mb-2 md:mb-2 lg:mb-4">
            ...
            Findtute offers a seamless platform for qualified tutors to connect
            with eager students and build a flourishing online teaching career.
            Here's why Findtute is the perfect fit for you:
          </p>
        </div>
        <div>
      ...
      <div className="flex flex-col gap-4 sm:flex-col md:flex-col lg:flex-col px-4 sm:px-4 md:px-16 lg:px-48 items-center justify-between mt-4 sm:mt-4 md:mt-8 lg:mt-16 mb-8 sm:mb-8 md:mb-16 lg:mb-24 sm:gap-4 md:gap-8 lg:gap-14">
        <div>
          ...
          <p className="text-justify text-lg ms-1 sm:text-lg md:text-xl lg:text-2xl sm:ms-2 md:ms-6 lg:ms-9">
            <strong>Ditch the complex registration processes!</strong> Findtute
        ...
        <div>
          ...
          <p className="text-justify text-lg ms-1 sm:text-lg md:text-xl lg:text-2xl sm:ms-2 md:ms-6 lg:ms-9">
            <strong>Empower the next generation! </strong>Findtute connects you
        ...
        <div>
          ...
          <p className="text-justify text-lg ms-1 sm:text-lg md:text-xl lg:text-2xl sm:ms-2 md:ms-6 lg:ms-9">
            <strong>Focus on teaching, not finances! </strong>Findtute offers a
        ...
        <div className="text-center">
          <h1 className="font-bold text-xl sm:text-xl md:text-2xl lg:text-3xl text-verdigris">
            ...
            difference? Sign up on Findtute today and embark on your rewarding
