        ...
        <div className="bg-warm lg:py-15 py-10">
            <div className="container">
                <div className="flex  md:flex-row flex-col justify-between items-center gap-10">
                    <div className="">
                        <h2 className="xl:text-[70px] lg:text-6xl md:text-5xl text-4xl font-bold leading-[117%]">Contact Us</h2>
                        <ul className="lg:pt-5 pt-3 flex items-center lg:gap-5 gap-2">
                            ...
                            <li><a href="#" className="lg:text-[28px] text-xl font-bold">Contact Us</a></li>
                        </ul>
                    </div>
    ...
    <div className="lg:pb-15 lg:pt-15 pb-10 pt-10">
        <div className="container">
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-7.5">
                ...
                <div className="bg-background rounded-md shadow-3xl pt-5 pb-7.5 px-7.5 text-center flex flex-col items-center wow fadeInUp" data-wow-delay=".3s">
                    <div className="w-16 h-16 rounded-full flex justify-center items-center bg-green">
                        <span className="text-cream-foreground text-[28px]"><i className="fa-solid fa-location-dot"></i></span>
                    </div>
                    <h5 className="font-bold text-xl mt-5 pb-2.5">Location</h5>
                    <p>120os road no12.Mirpur,Bangladesh</p>
                </div>
                
                <div className="bg-background rounded-md shadow-3xl pt-5 pb-7.5 px-7.5 text-center flex flex-col items-center wow fadeInUp" data-wow-delay=".4s">
                    <div className="w-16 h-16 rounded-full flex justify-center items-center bg-green">
                        <span className="text-cream-foreground text-[28px]"><i className="fa-solid fa-envelope"></i></span>
                    </div>
                    <h5 className="font-bold text-xl mt-5 pb-2.5">Mail</h5>
                    <p><a href="#">nafiz123@gmail.com</a>- <a href="#">fahad 1234@gmail.com</a></p>
                </div>
                
                <div className="bg-background rounded-md shadow-3xl pt-5 pb-7.5 px-7.5 text-center flex flex-col items-center wow fadeInUp" data-wow-delay=".5s">
                    <div className="w-16 h-16 rounded-full flex justify-center items-center bg-green">
                        <span className="text-cream-foreground text-[28px]"><i className="fa-solid fa-phone"></i></span>
                    </div>
    ...
    <section className="lg:pt-15 lg;pb-15 pb-10 pt-10">
        <div className="container">
            <div className="max-w-[546px] mx-auto text-center">
                <p className="text-secondary-foreground font-bubblegum-sans text-[19px]">Contact</p>
                <h2 className="font-bold lg:text-[32px] md:text-[28px] text-2xl lg:leading-[130%] md:leading-[120%] leading-[110%] wow fadeInUp" data-wow-delay=".3s">Unlock your potential with education</h2>
            </div>
            <div className="mt-15">
                    ...
                    <div className="relative">
                        <div className="absolute top-1/2 -translate-y-1/2 h-full flex flex-col justify-between">
                            <div className="mt-[68px] sm:w-full w-40 animate-up-down">
                                <img src="assets/images/contact/contact-2.png" alt="two-girls-img" />
                            </div>
                            ...
                            <form action="#" className="mt-7">
                                <div className="grid sm:grid-cols-2 grid-cols-1 gap-7.5">
                                    <div className="relative">
                                        ...
                                        <label for="name" className="absolute right-5 top-1/2 -translate-y-1/2"><i className="fa-solid fa-paper-plane"></i></label>
                                    </div>
                                    <div className="relative">
                                        ...
                                        <label for="email" className="absolute right-5 top-1/2 -translate-y-1/2"><i className="fa-solid fa-phone"></i></label>
                                    </div>
                                </div>
                                <div className="relative mt-5">
                                    <input type="text" placeholder="Your Address" id="address" className="w-full rounded-[10px] border-2 text-[#686868] placeholder:[#686868] border-[#F2F2F2] px-5 py-[15px] outline-none" />
                                    <label for="address" className="absolute right-5 top-1/2 -translate-y-1/2"><i className="fa-solid fa-location-dot"></i></label>
                                </div>
                                ...
                                <div className="relative mt-5">
                                    ...
                                    <label for="address" className="absolute right-5 top-[15px]"><i className="fa-solid fa-envelope"></i></label>
                                </div>
                                <button className="bg-primary text-cream-foreground rounded-full w-full lg:mt-10 mt-5 btn">Send Now</button>
                            </form>
                        </div>
                    </div>
                </div>
