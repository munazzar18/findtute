...
import { InquirePaymentStatus } from '../payment-request/actions/_action'
...
const PaymentSuccess = ({
  ...
  searchParams: { customerTransactionId: string }
}) => {
  const transactionId = searchParams.customerTransactionId
